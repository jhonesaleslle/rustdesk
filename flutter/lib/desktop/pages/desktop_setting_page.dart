...
class DesktopSettingPage extends StatefulWidget {
  ...
  static final List<SettingsTabKey> tabKeys = [
    // Tecnovetti: abas por variante.
    //  - CLIENTE (incoming-only): só "Sobre".
    //  - OPERADOR (isTecnoOperator): "Conta", "Impressora" e "Sobre".
    // Geral/Segurança/Rede/Tela ficam ocultas nas DUAS (o operador usa o
    // servidor/config embutidos pelo patch, não mexe nisso).
    if (isTecnoOperator && !bind.isDisableAccount()) SettingsTabKey.account,
    if (isTecnoOperator &&
        isWindows &&
        ...
        child: _Card(title: 'Sobre o TecnoAssist Client', children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://tecnovetti.cloud');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Tecnovetti',
                            style: const TextStyle(color: Colors.white),
                          ),
                          Text(
                            'Desenvolvido por Tecnovetti',
                            style: TextStyle(
